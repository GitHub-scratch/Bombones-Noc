...
import { Zap, Plus, Trash2, ChevronDown, ChevronUp, PackageOpen, History, Printer, X, Loader2, RefreshCw, Layers, PlusCircle, Database, Play, CheckCircle2, AlertCircle, TrendingUp, FileText } from 'lucide-react';
...
export default function Production({ materials, stock, productionHistory, activeSessions, fetchData, showToast }) {
  const [productionTab, setProductionTab] = useState('carga'); // 'carga' o 'finalizar'
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex bg-white p-1.5 rounded-2xl shadow-sm border border-chocolate/5">
          <button 
